...
const WORKOUT_MONTHS: WorkoutMonth[] = [
  { index: 1, title: 'תוכנית עקיפה', subtitle: 'שליטה בכדור', monthLabel: 'אפריל', year: 2026, month: 4, image: '/workouts/month-01.jpg', emoji: '🏀' },
  ...
  { index: 4, title: 'תוכנית עקיפה', subtitle: 'שליטה בכדור - מתקדם', monthLabel: 'יולי', year: 2026, month: 7, image: '/workouts/month-04.jpg', emoji: '⚡' },
  ...
  { index: 6, title: 'תוכנית שליטה', subtitle: 'שליטה בכדור', monthLabel: 'ספטמבר', year: 2026, month: 9, image: '/workouts/month-06.jpg', emoji: '🤲' },
  { index: 7, title: 'תוכנית עבודה', subtitle: 'ילדום ה׳', monthLabel: 'אוקטובר', year: 2026, month: 10, image: '/workouts/month-07.jpg', emoji: '💪' },
  { index: 8, title: 'תוכנית עקיפה', subtitle: 'מתאמנים אישיים', monthLabel: 'נובמבר', year: 2026, month: 11, image: '/workouts/month-08.jpg', emoji: '🏃' },
  ...
  { index: 11, title: 'תוכנית שליטה', subtitle: 'בכדור - ינואר', monthLabel: 'פברואר', year: 2027, month: 2, image: '/workouts/month-11.jpg', emoji: '🏀' },
  { index: 12, title: 'תוכנית קליעה', subtitle: 'אימונים אישיים', monthLabel: 'מרץ', year: 2027, month: 3, image: '/workouts/month-12.jpg', emoji: '🎯' },
  { index: 13, title: 'תוכנית עקיפה', subtitle: 'שלב מתקדם', monthLabel: 'אפריל', year: 2027, month: 4, image: '/workouts/month-13.jpg', emoji: '⚡' },
  { index: 14, title: 'תוכנית קליעה', subtitle: 'שלב מתקדם', monthLabel: 'מאי', year: 2027, month: 5, image: '/workouts/month-14.jpg', emoji: '🔥' },
  { index: 15, title: 'תוכנית כוח', subtitle: 'ומהירות', monthLabel: 'יוני', year: 2027, month: 6, image: '/workouts/month-15.jpg', emoji: '💪' },
  { index: 16, title: 'תוכנית קליעה', subtitle: 'מתקדמים', monthLabel: 'יולי', year: 2027, month: 7, image: '/workouts/month-16.jpg', emoji: '🎯' },
  { index: 17, title: 'תוכנית עקיפה', subtitle: 'רמה גבוהה', monthLabel: 'אוגוסט', year: 2027, month: 8, image: '/workouts/month-17.jpg', emoji: '⚡' },
  { index: 18, title: 'תוכנית קליעה', subtitle: 'קליעה בתנועה', monthLabel: 'ספטמבר', year: 2027, month: 9, image: '/workouts/month-18.jpg', emoji: '🏃' },
  { index: 19, title: 'תוכנית עקיפה', subtitle: 'מגע ותנועה', monthLabel: 'אוקטובר', year: 2027, month: 10, image: '/workouts/month-19.jpg', emoji: '🤲' },
  ...
  { index: 23, title: 'תוכנית עקיפה', subtitle: 'מתקדמים - Pro', monthLabel: 'פברואר', year: 2028, month: 2, image: '/workouts/month-23.jpg', emoji: '⚡' },
  { index: 24, title: 'תוכנית קליעה', subtitle: 'Elite', monthLabel: 'מרץ', year: 2028, month: 3, image: '/workouts/month-24.jpg', emoji: '🏆' },
  { index: 25, title: 'תוכנית משולבת', subtitle: 'Elite', monthLabel: 'אפריל', year: 2028, month: 4, image: '/workouts/month-25.jpg', emoji: '🏆' },
  { index: 26, title: 'תוכנית כוח', subtitle: 'Elite', monthLabel: 'מאי', year: 2028, month: 5, image: '/workouts/month-26.jpg', emoji: '💪' },
  { index: 27, title: 'תוכנית סיום', subtitle: 'סיכום ושיפור', monthLabel: 'יוני', year: 2028, month: 6, image: '/workouts/month-27.jpg', emoji: '🏅' },
];
