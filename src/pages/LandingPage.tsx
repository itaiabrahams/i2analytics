      ...
      <header className="relative min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-6 md:px-12">
          <div className="max-w-4xl text-center space-y-8">
            ...
            >
              I2 Analytics היא פלטפורמה מקצועית לכדורסל: ליווי וידאו אישי, מעקב קליעות על מגרש אינטראקטיבי, 
              חידוני IQ כדורסל, תוכניות אימון חודשיות ועוד — הכל במקום אחד, 
              מותאם לשחקנים צעירים ומאמנים שרוצים להתפתח.
            </motion.p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  icon: Video,
                  title: 'ליווי וידאו אישי',
                  desc: 'סשן ניתוח משחק מלא: תיעוד פעולות בזמן אמת, נקודות, ריבאונדים, אסיסטים, חטיפות ויומן פעולות עם ניקוד — הכל בפגישת וידאו עם מאמן.',
                },
                {
                  icon: Crosshair,
                  title: 'מעקב קליעות',
                  desc: 'מגרש חצי-סל אינטראקטיבי עם 12 אזורי קליעה. עקוב אחרי אחוזי קליעה מכל עמדה, צפה ב-Heat Map וראה את ההתקדמות שלך לאורך זמן.',
                },
                {
                  icon: Brain,
                  title: 'חידוני Court IQ',
                  desc: 'חידוני ידע כדורסל יומיים שמחדדים את ה-IQ שלך במגרש. ענה על שאלות, צבור נקודות, שמור על סטריק יומי והתחרה בלידרבורד.',
                },
                {
                  icon: Dumbbell,
                  title: 'תוכניות אימון',
                  desc: 'תוכנית עבודה חודשית מובנית: כל חודש נפתחת תוכנית חדשה הכוללת תרגילי שליטה בכדור, קליעה ועבודת כוח.',
                },
                {
                  icon: BarChart3,
                  title: 'סטטיסטיקות מתקדמות',
                  desc: 'גרפים ותרשימים שמציגים את ההתפתחות לאורך זמן: אחוזי קליעה מכל אזור, מגמות ביצועים וניקוד כולל.',
                },
                {
                  icon: Target,
                  title: 'יעדים ודירוגים',
                  desc: 'הגדרת מטרות אישיות בקטגוריות: התקפה, הגנה, כושר גופני. דירוגים תקופתיים מהמאמן עם הערות מפורטות.',
                },
                {
                  icon: Users,
                  title: 'ניהול שחקנים',
                ...
                {
                  icon: TrendingUp,
                  title: 'אתגרים ותחרויות',
                  desc: 'אתגרי קליעה שבועיים ואתגרים בין שחקנים. תחרויות ממריצות עם לידרבורד ודירוגים.',
                },
                {
                  icon: Shield,
                  title: 'פגישות וידאו',
